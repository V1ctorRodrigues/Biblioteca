...
Usuário, que possui ID único, nome e histórico de empréstimos;
Material, representado como classe abstrata, contendo ID único, título, status de disponibilidade e prazo de empréstimo definido conforme o tipo específico; 
e Empréstimo, responsável por associar um usuário a um material, armazenando data de empréstimo, data prevista de devolução, data efetiva de devolução e status do empréstimo.
...
O sistema segue regras de negócio bem definidas: 
Um material só pode ser emprestado se estiver disponível; 
IDs de usuários e materiais devem ser únicos; 
Um material não pode possuir dois empréstimos ativos simultaneamente;
A devolução encerra o empréstimo e libera o material para novos empréstimos; 
e atrasos são identificados com base na data prevista de devolução.
